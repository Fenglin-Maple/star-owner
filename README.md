...
普通用户应下载 GitHub Release 中的 `StarNote-BiliNote-v<version>-win-x64-small.zip`，解压后双击 `Start-StarNote.cmd`。便携包包含 Electron、Mermaid、FFmpeg、yt-dlp、Python、faster-whisper、CUDA 运行库和默认模型，不需要再次安装或拉取这些工具。
