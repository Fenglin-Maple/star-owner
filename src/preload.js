...
contextBridge.exposeInMainWorld('orchestrator', {
  ...
  sharedSetRepository: (payload) => ipcRenderer.invoke('shared:set-repository', payload),
  sharedCheckRepository: () => ipcRenderer.invoke('shared:check-repository'),
  sharedCreateRepository: (payload) => ipcRenderer.invoke('shared:create-repository', payload),
  sharedCatalog: (payload) => ipcRenderer.invoke('shared:catalog', payload),
  sharedUpload: (payload) => ipcRenderer.invoke('shared:upload', payload),
  sharedCancelUpload: () => ipcRenderer.invoke('shared:upload-cancel'),
  ...
  sharedSyncMounts: (mountIds) => ipcRenderer.invoke('shared:sync-mounts', mountIds),
