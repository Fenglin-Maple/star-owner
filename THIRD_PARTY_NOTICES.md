...
Star Note BiliNote is licensed under `GPL-3.0-or-later`. Third-party components remain under their own licenses; the project license does not replace or relicense them. A portable release is an aggregate containing separate executables, libraries, models, and application code.
