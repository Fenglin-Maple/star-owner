...
星藏家 (Star Owner) is licensed under `GPL-3.0-or-later`. Third-party components remain under their own licenses; the project license does not replace or relicense them. A portable release is an aggregate containing separate executables, libraries, models, and application code.
...
| DOMPurify | 3.4.12 | Apache-2.0 OR MPL-2.0 | Sanitizing the bundled project README HTML, [cure53/DOMPurify](https://github.com/cure53/DOMPurify) |
...
| `Systran/faster-whisper-medium` | revision `08e178d48790749d25932bbc082711ddcfdfbc4f` | MIT | Historical model retained for older releases; not exposed by the current registry |
| `dropbox-dash/faster-whisper-large-v3-turbo` | revision `0a363e9161cbc7ed1431c9597a8ceaf0c4f78fcf` | MIT | Default multilingual Turbo ASR model, exposed by faster-whisper as `large-v3-turbo` |
