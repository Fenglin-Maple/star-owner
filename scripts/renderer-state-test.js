...
(async () => {
  ...
  assert(singleStartFlow.includes('notifyBilibiliCookieRequired(error, notify)') && sessionActionFlow.includes('notifyBilibiliCookieRequired(error, notify)'), 'single-video create or retry failures do not show the bottom-right Bilibili login notice');
