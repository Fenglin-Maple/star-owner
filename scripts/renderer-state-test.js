...
(async () => {
  ...
  assert(index.includes('远程目录筛选') && index.indexOf('id="sharedCatalogList"') < index.indexOf('id="sharedMountSelectAll"') && index.indexOf('id="sharedClearMountSelection"') < index.indexOf('id="sharedMountList"'), 'local shared-collection controls were not placed between the remote and local lists');
